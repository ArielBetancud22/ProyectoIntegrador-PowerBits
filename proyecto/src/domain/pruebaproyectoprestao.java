...
public class tiendaInterdata {
    ...
    // Subproceso del menú buzos
    public static void MenuBuzos(float compraTotal, String compraProductos) {
        int modelo, cantidad;
        float precio = 0;
    ...
    public static void MenuCamperas(float compraTotal, String compraProductos) {
        int modelo, cantidad;
        float precio = 0;
        String nombreModelo = null;
        int agregarOpcion = 0;
    ...
    public static void MenuJeans(float compraTotal, String compraProductos) {
        int modelo, cantidad;
        float precio = 0;
        String nombreModelo = null;
        int agregarOpcion = 0;
    ...
    public static void MenuPantalones(float compraTotal, String compraProductos) {
        int modelo, cantidad;
        float precio = 0;
        String nombreModelo = null;
        int agregarOpcion = 0;
    ...
    public static void MenuCamisas(float compraTotal, String compraProductos) {
        int modelo, cantidad;
        float precio = 0;
        String nombreModelo = null;
        int agregarOpcion = 0;
    ...
    public static void MenuTrajes(float compraTotal, String compraProductos) {
        int modelo, cantidad;
        float precio = 0;
        String nombreModelo = null;
        int agregarOpcion = 0;
    ...
    public static void MetodoPago(float compraTotal) {
